...
RSpec.describe Movie, type: :model do
  ...
  describe "scopes" do
    before :each do
      Movie.create(title: "a title", rank: 56)
      Movie.create(title: "b title", rank: 6)
      Movie.create(title: "c title", rank: 10)
      Movie.create(title: "d title", rank: 500)
      Movie.create(title: "e title", rank: 3)
      Movie.create(title: "f title", rank: 23)
