...
movies = [
  ...
  {name: "Fancy movie", director: "Dr. Walentin", description:"this is a test", ranking: 10},
  {name: "Another fancy movie", director: "Dr. Walentin", description:"this is a test", ranking: 50}
...
books = [
  ...
  {name: "Mary's Little Lamb", author: "Baa Baa Black Sheep", description: "Snow white fleece, has a definite whose my mother complex, you get the idea. She's a total mama's girl.", ranking: 30}
]
